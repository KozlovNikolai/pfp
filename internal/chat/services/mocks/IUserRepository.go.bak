...
import (
	...
	domain "github.com/KozlovNikolai/pfp/internal/chat/domain"
...
func (_m *IUserRepository) CreateUser(_a0 context.Context, _a1 domain.User) (domain.User, error) {
...
func (_m *IUserRepository) DeleteUser(_a0 context.Context, _a1 int) error {
	ret := _m.Called(_a0, _a1)
...
func (_m *IUserRepository) GetUserByID(_a0 context.Context, _a1 int) (domain.User, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *IUserRepository) GetUserByLogin(_a0 context.Context, _a1 string) (domain.User, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *IUserRepository) GetUsers(_a0 context.Context, _a1 int, _a2 int) ([]domain.User, error) {
...
func (_m *IUserRepository) UpdateUser(_a0 context.Context, _a1 domain.User) (domain.User, error) {
	ret := _m.Called(_a0, _a1)
