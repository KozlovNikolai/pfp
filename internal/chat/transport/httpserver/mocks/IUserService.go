...
func (_m *IUserService) CreateUser(_a0 context.Context, _a1 domain.User) (domain.User, error) {
...
func (_m *IUserService) DeleteUser(_a0 context.Context, _a1 int) error {
	ret := _m.Called(_a0, _a1)
...
func (_m *IUserService) GetUserByID(_a0 context.Context, _a1 int) (domain.User, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *IUserService) GetUserByLogin(_a0 context.Context, _a1 string) (domain.User, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *IUserService) GetUsers(_a0 context.Context, _a1 int, _a2 int) ([]domain.User, error) {
...
func (_m *IUserService) UpdateUser(_a0 context.Context, _a1 domain.User) (domain.User, error) {
	ret := _m.Called(_a0, _a1)
