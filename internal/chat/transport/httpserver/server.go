...
func NewRouter() *Router {
	...
	authorized.POST("createPrivateChat", httpServer.CreatePrivateChat)
	authorized.POST("addContactToAccount", httpServer.AddContactToAccount)
	authorized.GET("getContacts", httpServer.GetContactsByAccount)
	...
	authorized.GET("getusers", httpServer.FindUsers)
	return server
}
